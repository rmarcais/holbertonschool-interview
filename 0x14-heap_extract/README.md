...
<p align="center">
<img src="https://i.redd.it/xyq73k1hf0d81.png" alt="meme">
</p>
...
```
remi@/tmp/binary_trees$ gcc -Wall -Wextra -Werror -pedantic -o 0-heap_extract 0-main.c 0-heap_extract.c binary_tree_print.c -L. -lheap
remi@/tmp/binary_trees$ valgrind ./0-heap_extract
