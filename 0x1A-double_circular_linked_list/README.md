...
<p align="center">
<img src="https://i.redd.it/j37f60iy2s651.jpg" alt="meme">
</p>
...
### Expected output
```
remi@ubuntu:0x1A-double_circular_linked_list$ gcc -Wall -Wextra -Werror -pedantic 0-main.c 0-add_node.c
remi@ubuntu:0x1A-double_circular_linked_list$ ./a.out 
Holberton
        ->prev: Engineer
        ->next: School
School
...
Holberton
        ->prev: School
        ->next: Engineer
remi@ubuntu:0x1A-double_circular_linked_list$ 
```