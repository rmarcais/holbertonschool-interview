...
<p align="center">
<img src="https://www.fondamentaux.org/wp-content/uploads/2021/10/regex.jpeg" alt="meme">
</p>
...
```
remi@~/holbertonschool-interview_prep/0x20-regex$ gcc -Wall -Wextra -Werror -pedantic main.c regex.c
remi@~/holbertonschool-interview_prep/0x20-regex$ ./a.out
H -> H = 1
HH -> H = 0
HH -> H* = 1
...
remi@~/holbertonschool-interview_prep/0x20-regex$
```
